 ...
 */
class Elements(val data: MutableList<Element> = mutableListOf()) : MutableList<Element> by data {

    constructor(initialCapacity: Int): this(ArrayList(initialCapacity))

    constructor(elements: Collection<Element>) : this(ArrayList(elements))

    constructor(vararg elements: Element) : this(ArrayList(elements.asList()))
    ...
    fun parents(): Elements {
        val combo: MutableSet<Element> = LinkedHashSet()
        for (e in this) {
